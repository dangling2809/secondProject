(function() {
	...
	d = (function() {
		...
		c.prototype.build = function() {
			...
			b(
					"<div id='lightboxOverlay' class='lightboxOverlay'></div>"
							...
							"<a class='lb-close'></a></div><span class='lb-caption' style='margin:90px;'></span>"+
			...
			return this.$lightbox.find('.lb-close').on('click',
					function() {
						c.end();
						return false
					})
		...
		c.prototype.changeImage = function(f) {
			...
			this.$lightbox
					.find(
							'.lb-image, .lb-nav, .lb-prev, .lb-next, .lb-dataContainer, .lb-numbers')
					.hide();
